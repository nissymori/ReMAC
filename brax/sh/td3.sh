...
python train.py --config configs/brax/humanoidstandup.yaml --algorithm td3 --num-seeds=$num_seeds --set total_timesteps=$total_timesteps --set eval_freq=$eval_freq --wandb --wandb-project=$wandb_project --seed_id=$seed